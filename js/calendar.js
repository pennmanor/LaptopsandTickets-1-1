...
(function($) {
    ...
    Calendar.prototype._update_month = function() {
        ...
        $('a.event').mouseenter(function() {
            $('a.event' + $(this).data('event-id')).parents('li').addClass('day-highlight dh-' + $(this).data('event-class'));
        });
        $('a.event').mouseleave(function() {
            $('a.event' + $(this).data('event-id')).parents('li').removeClass('day-highlight dh-' + $(this).data('event-class'));
        });
